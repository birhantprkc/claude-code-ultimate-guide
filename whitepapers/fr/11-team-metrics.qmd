...
| LiteLLM + Loki + Tempo + Grafana | Stack self-hosted : spend par équipe, volume de requêtes par modèle, headroom budgétaire | Équipes qui veulent du cost/usage tracking sans outil SaaS payant | Ne calcule ni CFR ni lead time, complète LinearB/Faros plutôt que les remplacer. Voir [API Gateway](https://cc.bruniaux.com/guide/ops/api-gateway/) |

Aucun outil ne remonte automatiquement les métriques AI-specific décrites plus haut (CFR par origine du code, comparaison temps de revue, signaux de compréhension), et ça reste vrai même avec la stack self-hosted ci-dessus. Ça nécessite soit des dashboards custom construits sur vos données CI/CD, soit un tracking manuel. GitHub Analytics couvre le % de code assisté par IA ; le reste vous devrez le câbler vous-même.
...
- [Observabilité des Sessions](https://cc.bruniaux.com/guide/ops/observability/) : monitoring des sessions Claude Code, tracking des coûts, patterns d'usage
- [Traçabilité IA](https://cc.bruniaux.com/guide/ops/ai-traceability/) : audit des contributions IA, attribution et conformité
- [Déployer en Équipe](https://cc.bruniaux.com/guide/roles/team-deployment/) : adoption Claude Code en équipe, CI/CD, champions program
- [API Gateway](https://cc.bruniaux.com/guide/ops/api-gateway/) : LiteLLM/Portkey, clés virtuelles, budgets par équipe, allowlists de modèles
