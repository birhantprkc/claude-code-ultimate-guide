...
**Xcode (Feb 2026):** the most recent integration. Xcode 26.3 RC+ includes native support for the Claude Agent SDK, exposing the same capabilities as the CLI directly in the Apple IDE. Configuration via Xcode > Preferences > Claude.
