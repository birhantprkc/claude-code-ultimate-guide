...
The Tasks API (v2.1.16+, default since v2.1.142) introduces a four-level structure to break down any complex project in a clear and traceable way.
...
| `failed` | Failed, with error metadata for debugging |
