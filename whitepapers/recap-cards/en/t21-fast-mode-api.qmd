...
Fast Mode produces responses **2.5x faster** in exchange for a 2x higher cost (verified for Opus 4.8). The underlying model is Opus 4.8, not a different model: this is priority resource allocation, not simplified reasoning.

| Parameter | Standard | Fast Mode |
|-----------|----------|-----------|
| Model | Opus 4.8 | Opus 4.8 |
| Speed | Reference | 2.5x faster |
| Input price | See official docs | 2x standard |
| Output price | See official docs | 2x standard |
