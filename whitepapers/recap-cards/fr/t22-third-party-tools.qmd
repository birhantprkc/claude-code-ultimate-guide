...
Les outils de cette fiche sont des couches adjacentes: ils observent, configurent ou coordonnent des sessions. Ils ne remplacent pas le runtime qui possède la boucle agentique. Pour choisir un runtime ou un orchestrateur, consulter le [Agent Harness Map](https://cc.bruniaux.com/guide/agent-harness-landscape/).
...
Les capacités et la maintenance de ces projets évoluent séparément de Claude Code. Vérifier le dépôt, les permissions et la release ciblée avant installation; le [glossaire](https://cc.bruniaux.com/guide/glossary/) distingue runtime, orchestrateur, protocole et outil adjacent.
