...
Fast Mode produit des réponses **2.5x plus rapides** en échange d'un coût 2x supérieur (vérifiée pour Opus 4.8). Le modèle sous-jacent est Opus 4.8, pas un modèle différent : c'est une allocation de ressources prioritaire, pas une simplification du raisonnement.

| Paramètre | Standard | Fast Mode |
|-----------|----------|-----------|
| Modèle | Opus 4.8 | Opus 4.8 |
| Vitesse | Référence | 2.5x plus rapide |
| Prix input | Voir docs officielles | 2x standard |
| Prix output | Voir docs officielles | 2x standard |
