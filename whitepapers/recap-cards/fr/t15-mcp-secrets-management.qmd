...
**`CLAUDE_CODE_SUBPROCESS_ENV_SCRUB` (v2.1.83+)** : variable d'environnement qui force Claude Code à supprimer les variables sensibles (`*_KEY`, `*_TOKEN`, `*_SECRET`) avant de les transmettre aux sous-processus et serveurs MCP. Activer en production pour limiter la surface d'exposition.
