...
**Xcode (Feb 2026) :** l'intégration la plus récente. Xcode 26.3 RC+ inclut un support natif du Claude Agent SDK, exposant les mêmes capacités que le CLI directement dans l'IDE Apple. Configuration via Xcode > Preferences > Claude.
