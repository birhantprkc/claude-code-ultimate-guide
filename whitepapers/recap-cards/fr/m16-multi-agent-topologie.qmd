...
Prérequis : Claude Code v2.1.32+, modèle un modèle accessible au compte (les coéquipiers peuvent différer), dépôt git initialisé. Navigation entre agents via `Shift+Down` en mode in-process.
