...
Être explicite sur "FAILING" et "n'existe pas encore" compte, sinon Claude tend à écrire test et implémentation ensemble.
...
Les scénarios servent à la fois de spec, de documentation et de base de test, dans un langage lisible par des non-développeurs.
...
TaskCreate("Écrire les tests failing pour auth")
TaskCreate("Implémenter auth pour passer les tests", {
  blockedBy: ["task-tests-failing"]
})
TaskCreate("Refactoriser auth", {
