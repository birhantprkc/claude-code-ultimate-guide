...
Boris Cherny (Head of Claude Code chez Anthropic) commence environ **80% de ses tâches en Plan Mode**, laissant Claude planifier avant d'écrire une seule ligne de code. L'exécution est ainsi presque toujours correcte au premier essai.
