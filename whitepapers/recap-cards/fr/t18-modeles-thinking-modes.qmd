...
| **Fable 5** | Voir docs officielles | Tâches les plus complexes (Mythos-class) |
| **Opus 4.8** | Voir docs officielles | Architecture, sécurité, audit |
...
Opus 4.8 utilise l'**Adaptive Thinking** : le modèle alloue dynamiquement son budget de calcul selon la complexité de la requête. Le paramètre `effort` contrôle cette profondeur.
...
- **max** : raisonnement cross-système, décisions irréversibles (Opus 4.8+)
...
Les keywords `ultrathink`, `think hard` n'ont plus d'effet fonctionnel depuis v2.0.67. Le thinking adaptatif est actif par défaut sur Opus 4.8.
