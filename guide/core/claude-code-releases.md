...
| Date | Feature |
|------|---------|
| 2026-01-29 | **Structured Outputs GA**: `output_config.format` replaces `output_format`. [Docs](https://platform.claude.com/docs/en/build-with-claude/structured-outputs) |
